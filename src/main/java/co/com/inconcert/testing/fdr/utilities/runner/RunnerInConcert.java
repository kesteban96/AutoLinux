package co.com.inconcert.testing.fdr.utilities.runner;
 ...
 * */
public class RunnerInConcert extends Runner {
  private static final Logger LOGGER = LogManager.getLogger(RunnerInConcert.class.getName());
  private Class<CucumberWithSerenity> classValue;
  private CucumberWithSerenity cucumberWithSerenity;

  public RunnerInConcert(Class<CucumberWithSerenity> classValue)
